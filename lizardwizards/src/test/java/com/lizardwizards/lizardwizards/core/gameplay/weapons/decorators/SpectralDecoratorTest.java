...
/**
 * Parasoft Jtest UTA: Test class for SpectralDecorator
 *
 * @see SpectralDecorator
 * @author povilas
 */
public class SpectralDecoratorTest
{
    /**
     * Parasoft Jtest UTA: Test for ContinueShooting(double, Vector2, Vector2)
     *
     * @author povilas
     * @see SpectralDecorator#ContinueShooting(double, Vector2, Vector2)
     */
    @Test
    public void testContinueShooting() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            SpectralDecorator underTest = new SpectralDecorator(weapon);
