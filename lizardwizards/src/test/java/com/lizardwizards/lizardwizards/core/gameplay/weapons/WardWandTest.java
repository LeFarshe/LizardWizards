...
/**
 * Parasoft Jtest UTA: Test class for WardWand
 *
 * @see WardWand
 * @author povilas
 */
public class WardWandTest
{
    /**
     * Parasoft Jtest UTA: Test for Shoot(Vector2, Vector2)
     *
     * @author povilas
     * @see WardWand#Shoot(Vector2, Vector2)
     */
    @Test
    public void testShoot() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            // Given
            WardWand underTest = new WardWand();
     ...
     *
     * @author povilas
     * @see WardWand#accept(BoltEnergizerVisitor)
     */
    @Test
    ...
    public void testClone() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            // When
            WardWand result = underTest.clone();
