...
/**
 * Parasoft Jtest UTA: Test class for TenetShotsDecorator
 *
 * @see TenetShotsDecorator
 * @author povilas
 */
public class TenetShotsDecoratorTest
{
    /**
     * Parasoft Jtest UTA: Test for ContinueShooting(double, Vector2, Vector2)
     *
     * @author povilas
     * @see TenetShotsDecorator#ContinueShooting(double, Vector2, Vector2)
     */
    @Test
    public void testContinueShooting() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            TenetShotsDecorator underTest = new TenetShotsDecorator(weapon);
    ...
    public void testClone() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            // When
            WeaponDecorator result = underTest.clone();
