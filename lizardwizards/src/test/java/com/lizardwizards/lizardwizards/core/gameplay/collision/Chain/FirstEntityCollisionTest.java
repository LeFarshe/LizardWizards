...
/**
 * Parasoft Jtest UTA: Test class for FirstEntityCollision
 *
 * @see FirstEntityCollision
 * @author povilas
 */
public class FirstEntityCollisionTest
{
    /**
     * Parasoft Jtest UTA: Test for collide(CollisionLayer, CollisionLayer)
     *
     * @author povilas
     * @see FirstEntityCollision#collide(CollisionLayer, CollisionLayer)
     */
    @Test
    public void testCollide() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            FirstEntityCollision underTest = new FirstEntityCollision(layer);
