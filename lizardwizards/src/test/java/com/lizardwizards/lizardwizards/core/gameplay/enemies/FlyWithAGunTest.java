...
/**
 * Parasoft Jtest UTA: Test class for FlyWithAGun
 *
 * @see FlyWithAGun
 * @author povilas
 */
public class FlyWithAGunTest
{
    /**
     * Parasoft Jtest UTA: Test for getSprite()
     *
     * @author povilas
     * @see FlyWithAGun#getSprite()
     */
    @Test
    public void testGetSprite() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            FlyWithAGun underTest = new FlyWithAGun(position);
     ...
     *
     * @author povilas
     * @see Enemy#Collide(Entity, CollisionLayer)
     */
    @Test
