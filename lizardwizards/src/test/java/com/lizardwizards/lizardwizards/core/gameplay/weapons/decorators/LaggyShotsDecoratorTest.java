...
/**
 * Parasoft Jtest UTA: Test class for LaggyShotsDecorator
 *
 * @see LaggyShotsDecorator
 * @author povilas
 */
public class LaggyShotsDecoratorTest
{
    /**
     * Parasoft Jtest UTA: Test for ContinueShooting(double, Vector2, Vector2)
     *
     * @author povilas
     * @see LaggyShotsDecorator#ContinueShooting(double, Vector2, Vector2)
     */
    @Test
    public void testContinueShooting() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            LaggyShotsDecorator underTest = new LaggyShotsDecorator(weapon);
    ...
    public void testClone() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            // When
            LaggyShotsDecorator result = underTest.clone();
