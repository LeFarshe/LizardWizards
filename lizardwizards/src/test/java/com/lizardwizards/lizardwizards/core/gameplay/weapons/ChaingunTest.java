...
/**
 * Parasoft Jtest UTA: Test class for Chaingun
 *
 * @see Chaingun
 * @author povilas
 */
public class ChaingunTest
{
    /**
     * Parasoft Jtest UTA: Test for Shoot(Vector2, Vector2)
     *
     * @author povilas
     * @see Chaingun#Shoot(Vector2, Vector2)
     */
    @Test
    public void testShoot() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            // Given
            Chaingun underTest = new Chaingun();
     ...
     *
     * @author povilas
     * @see Chaingun#accept(BoltEnergizerVisitor)
     */
    @Test
    ...
    public void testClone() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            // When
            Chaingun result = underTest.clone();
