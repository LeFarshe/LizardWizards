...
/**
 * Parasoft Jtest UTA: Test class for TestWeapon
 *
 * @see TestWeapon
 * @author povilas
 */
public class TestWeaponTest
{
    /**
     * Parasoft Jtest UTA: Test for Shoot(Vector2, Vector2)
     *
     * @author povilas
     * @see TestWeapon#Shoot(Vector2, Vector2)
     */
    @Test
    public void testShoot() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            // Given
            double shootDelay = 0.0d; // UTA: default value
            double firerate = 0.0d; // UTA: default value
            TestWeapon underTest = new TestWeapon(shootDelay, firerate);
     ...
     *
     * @author povilas
     * @see TestWeapon#accept(BoltEnergizerVisitor)
     */
    @Test
    ...
    public void testClone() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            // When
            TestWeapon result = underTest.clone();
