...
/**
 * Parasoft Jtest UTA: Test class for Shotgun
 *
 * @see Shotgun
 * @author povilas
 */
public class ShotgunTest
{
     ...
     *
     * @author povilas
     * @see Shotgun#Shoot(Vector2, Vector2)
     */
    @Test
     ...
     *
     * @author povilas
     * @see Shotgun#accept(BoltEnergizerVisitor)
     */
    @Test
    ...
    public void testClone() throws Throwable {
        ...
        assertTimeoutPreemptively(ofMillis(5000), () -> {
            ...
            // When
            Shotgun result = underTest.clone();
